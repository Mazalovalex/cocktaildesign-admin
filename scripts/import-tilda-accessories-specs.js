...
const CSV_FILE = process.env.CSV_FILE || 'imports/tilda-accessories.csv';
const SERVER_CODES_PATH = process.env.SERVER_CODES_PATH || '/tmp/accessories-empty-products.tsv';
...
const TARGET_ITEMS = [
  {
    code: 'Arm',
    title: 'Армбэнды тканевые Shao',
    specs: [
      ['Тип товара', 'Армбэнды'],
      ['Тип', 'Тканевые армбэнды'],
      ['Назначение', 'Для фиксации рукавов во время работы'],
      ['Материал', 'Текстиль, металлическая фурнитура'],
      ['Цвет / покрытие', 'Разные цвета'],
      ['Особенности', 'Универсальный размер'],
    ],
  },
  {
    code: 'ArmMtl',
    title: 'Армбэнды металлические',
    specs: [
      ['Тип товара', 'Армбэнды'],
      ['Тип', 'Металлические армбэнды'],
      ['Назначение', 'Для фиксации рукавов во время работы'],
      ['Материал', 'Нержавеющая сталь'],
      ['Цвет / покрытие', 'Черный; Серебро; Золото'],
      ['Особенности', 'Универсальный размер; Пружинный тип; Тонкий профиль'],
    ],
  },
];
