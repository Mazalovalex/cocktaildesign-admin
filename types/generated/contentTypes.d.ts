...
export interface ApiCatalogCollectionCatalogCollection
  extends Struct.CollectionTypeSchema {
  collectionName: 'catalog_collections';
  info: {
    displayName: '\u041F\u043E\u0434\u0431\u043E\u0440\u043A\u0430 \u0442\u043E\u0432\u0430\u0440\u043E\u0432';
    pluralName: 'catalog-collections';
    singularName: 'catalog-collection';
  };
  options: {
...
export interface ApiKnowledgeItemKnowledgeItem
  ...
  attributes: {
    ...
    format: Schema.Attribute.Enumeration<['video', 'article', 'material']> &
      Schema.Attribute.Required;
    ...
    tab: Schema.Attribute.Enumeration<
      ['techniques', 'education', 'podcasts', 'industry', 'resources']
    > &
      Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiMoyskladCategoryMoyskladCategory
  ...
  info: {
    ...
    pluralName: 'moysklad-categories';
    singularName: 'moysklad-category';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiMoyskladProductMoyskladProduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'moysklad_products';
  info: {
    displayName: '\u0422\u043E\u0432\u0430\u0440\u044B';
    pluralName: 'moysklad-products';
    singularName: 'moysklad-product';
  };
  options: {
    draftAndPublish: false;
  };
