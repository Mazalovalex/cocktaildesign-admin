...
const MODELS = [
  {
    ...
    fields: {
      ...
      isHiddenInMenu: {
        label: 'Скрыть в меню каталога',
        description:
          'Подборка не отображается в меню “Каталог”, но её страница и другие блоки продолжают работать.',
      },
    },
  },
  {
  ...
  {
    kind: 'content-type',
    uid: 'api::mobile-navigation.mobile-navigation',
    fields: {
      items: {
        label: 'Пункты мобильной навигации',
        description:
          'Пункты мобильной навигации. Их порядок в этом списке определяет порядок отображения на сайте.',
      },
    },
  },
  {
    kind: 'component',
    uid: 'navigation.mobile-navigation-item',
    fields: {
      title: {
        label: 'Название',
        description:
          'Название пункта, которое видит пользователь. Например: «Каталог», «Новинки», «Уценка» или «Система скидок».',
      },
      href: {
        label: 'Ссылка',
        description:
          'Ссылка, по которой откроется пункт меню. Для внутренних страниц указывайте путь от корня сайта, начиная с /. Например: /catalog или /catalog/collection/novinki.',
      },
      homeImage: {
        label: 'Изображение на главной',
        description:
          'Изображение для горизонтального меню на главной странице мобильной версии сайта.',
      },
      menuImage: {
        label: 'Изображение в меню',
        description:
          'Изображение для карточки в полноэкранном меню, которое открывается по кнопке «Меню» в нижней мобильной навигации.',
      },
      showInHome: {
        label: 'Показывать на главной',
        description:
          'Показывать этот пункт в горизонтальном меню на главной странице мобильной версии.',
      },
      showInMenu: {
        label: 'Показывать в меню',
        description:
          'Показывать этот пункт в полноэкранном мобильном меню, которое открывается по кнопке «Меню».',
      },
      isActive: {
        label: 'Активен',
        description:
          'Главный переключатель пункта. Если выключен, пункт не отображается ни на главной странице, ни в мобильном меню.',
      },
    },
  },
];
